	...
	jsPlumb.DemoList = {
		...
		init : function() {
			...
			if (demoInfo) {
				...
				//document.getElementById("render").innerHTML = renderModeString + libraryString + demoSelectorString;
				
				//ALESSANDRO:
				//aqui carrega o html total com o combo do select que tem os htmls
				//a� l� embaixo tem a implementa��o do onChange
				
				//ALESSANDRO:
				//Comentado tb.
				//document.getElementById("render").innerHTML = demoSelectorString;
				...
				//ALESSANDRO:
				//comentando para limpar a tela.. ok, s� tirou o menu
				...
				ds.onchange = function() {
				    alert(ds.options[ds.selectedIndex].value);
					//ALESSANDRO:
					//aqui carrega o html espec�fico chamando o espec�fico js
