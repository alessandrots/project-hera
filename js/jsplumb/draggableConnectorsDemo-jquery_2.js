/****
ALESSANDRO:
Atributo maxConnections permitindo a conex�o de um n�mero m�ximo de conectores entre as divs.

Entender o funcionamento dos endpoints, com eles � poss�vel, definir o n�mero de conex�es,

estes endpoints (exampleEndpoint**) est�o associados aos divs q est�o na tela.. infelizmente.. o q � feito aqui
� atualizado no html, com a fun��o html() l� no document.getElementById("render").innerHTML = demoSelectorString;
no demo-list.js

Nas linhas aonde � definido var e1, var e2... � o que define onde cada endpoint, aparece, o grande lance � entender
o anchor:[0.25, 0, 0, -1]
**/
	...
	var _initialised = false,
		...
		updateConnections = function(conn, remove) {
			...
			if (connections.length > 0) {
				//montando a tabela que aparece qdo h� conex�o
		...
		init : function() {
			...
			if (!_initialised) {
				...
				$(".detach").click(function() {
				        //alert('detachh All - todos que tem ahref com rel');
	       ...
	       criarConexao : function(id) {
		      ...
		      //alert('teste = ' + id);e
		      var exampleColorX = "#00f";
		      var exampleEndpointX = {
			      //endpoint:"Rectangle", 
			      endpoint:["Dot", {radius:9} ],	//mudei aqui		      
			      paintStyle:{ width:25, height:21, fillStyle:exampleColorX },
			      isSource:true,
			      reattach:true,
			      scope:"blue rectangle",
			      connectorStyle : {
				      gradient:{stops:[[0, exampleColorX], [0.5, "#09098e"], [1, exampleColorX]]},
				      lineWidth:5,
				      strokeStyle:exampleColorX,
				      dashstyle:"2 2"
			      },
			      isTarget:true,
			      /*
		      ...
		      //jsPlumb.addEndpoint(id, { anchor:[1, 0.8, 1, 1] }, exampleEndpointX);
		      jsPlumb.addEndpoint(id, { anchor:[0, 0, 0, 0] }, exampleEndpointX);
		      //jsPlumb.addEndpoint(id, { anchor:[0.2, 0, 0, 0] }, exampleEndpointX);
		      jsPlumb.addEndpoint(id, { anchor:[0.4, 0, 0, 0] }, exampleEndpointX);
		      //jsPlumb.addEndpoint(id, { anchor:[0.6, 0, 0, 0] }, exampleEndpointX);
		      jsPlumb.addEndpoint(id, { anchor:[0.8, 0, 0, 0] }, exampleEndpointX);
		      //jsPlumb.addEndpoint(id, { anchor:[1, 0, 0, 0] }, exampleEndpointX);
		      
		      
		      jsPlumb.draggable($(".window"));
		      
		      $(".detach").click(function() {
			      //alert('detachh All 2- todos que tem ahref com rel'); //OK apagou as conexões
			      jsPlumb.detachAllConnections($(this).attr("rel"));
		      });
	       },
