...
Theater.Collections.Movies = Backbone.Collection.extend({
    ...
    //url: "http://localhost:8080/engine/backbone/movies.json",
    url: "/engine/backbone/movies.json",
...
//pegou o template de listagem dos filmes
...
Theater.Views.Movies = Backbone.View.extend({
	...
	//aqui faz a renderização
        this.addAll();
    },

    addAll: function () {
        console.log("addAll")
	//Aqui adiciona cada linha
...
//pegou o template que vai ser usado para cada filme especificamente
